namespace IgrejaApp.UI.Themes;

public abstract class Classes
{
    public const string InputLogin =
        "valid block w-full rounded-md bg-white px-3 py-1.5 text-base md:text-lg text-black outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 sm:text-sm/6";
